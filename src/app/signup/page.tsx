...
import { InputField, AuthPageSkeleton } from "@/shared/components";
...
export default function SignupPage() {
  ...
  const validateForm = () => {
    ...
    // Validate password using canonical validator
    ...
    try {
      ...
      if (result.success) {
        ...
        if (result.errors && Object.keys(result.errors).length > 0) {
          ...
          showError(result.error || "Please fix the errors and try again.");
        } else {
          // Show general error message
