  ...
  createTableCardConfig({
    columns: [
      ...
      createTableCardColumn({
        ...
        order: 2,
        icon: "bi-person",
        render: (item) => <Badge variant="primary">{item.paidBy}</Badge>,
      }),
      createTableCardColumn({
        key: "isSplit",
        label: "Split",
  ...
  createTableCardConfig({
    columns: [
      ...
      createTableCardColumn({
        ...
        render: (item) => <Badge variant="danger">{item.fromUser}</Badge>,
      }),
      createTableCardColumn({
        key: "toUser",
        label: "To",
        ...
        render: (item) => <Badge variant="success">{item.toUser}</Badge>,
      }),
      createTableCardColumn({
        key: "status",
        label: "Status",
